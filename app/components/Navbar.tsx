...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/90 dark:bg-slate-950/90 backdrop-blur-xl border-b border-slate-200 dark:border-white/5 transition-colors">
      <div className="max-w-7xl mx-auto px-4 md:px-8 flex items-center justify-between h-16">
        ...
        <div className="flex items-center gap-6">
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-cyan-500 dark:from-emerald-400 dark:to-cyan-400 font-black text-xl tracking-tighter uppercase font-display">
              Old Legends
            </span>
          </Link>

          <div className="hidden md:block h-6 w-px bg-slate-200 dark:bg-white/10 transition-colors" />
      ...
      <div className={clsx(
        "lg:hidden absolute top-full left-0 w-full bg-white dark:bg-slate-950 border-b border-slate-200 dark:border-white/5 transition-all duration-500 overflow-hidden",
